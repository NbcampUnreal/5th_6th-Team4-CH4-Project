...
void UAFScoreboardWidget::NativeConstruct()
{
	...
	if (Btn_Exit)
	{
		Btn_Exit->OnClicked.AddDynamic(this, &UAFScoreboardWidget::OnExitClicked);
	}

}

void UAFScoreboardWidget::OnExitClicked()
{
	UGameplayStatics::OpenLevel(GetWorld(), TEXT("TitleMenu"));
}
