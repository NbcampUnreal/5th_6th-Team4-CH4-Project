    ...
    public:
        ...
        void InitializeSkills(const FString& CharacterName, UDataTable* SkillTable);

        FAFSkillInfo* GetSkillData(FName SkillRowName);
    ...
    protected:
        ...
        UPROPERTY()
        TMap<FName, FAFSkillInfo> LoadedSkills;

        UPROPERTY(EditAnywhere, Category = "AF|Data")
        UDataTable* InternalSkillTable;
